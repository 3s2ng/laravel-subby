...
trait HasSubscriptions
{
     ...
     * @throws \Exception
     */
    public function newSubscriptionPlan(?string $tag, Plan|PlanCombination $planCombination, ?string $name = null, ?string $description = null, ?Carbon $startDate = null, $paymentMethod = 'free')
    {
